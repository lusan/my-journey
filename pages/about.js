    ...
    <React.Fragment>
      ...
      <main className={classes.main}>
        ...
        <Typography  align="left" paragraph>
          I am a Frontend Engineer with over 5 years of experience building amazing products from scratch. I also write about technologies I learn from time to time.
          I started my career in <a href="https://www.ibm.com/in-en" title="IBM">IBM</a>, but soon I realised I wanted to explore the world of startups. Hence I joined my first startup FindYogi that changed my career forever.
        </Typography>
        <Typography  align="left" paragraph>
          In <a href="https://www.findyogi.com/" title="FindYogi" target="_blank">FindYogi</a>, I got a great mentor who taught me the relevance of writing good code and learnt a lot of Javascript along the way.
          Being in an e-commerce startup, my work really pushed me to learn and build amazing frontend. Eventually we went on to get aquired by way2online,
        ...
        <Typography  align="left" paragraph>
          During all these years, I went on to learn a lot of web technologies like
          HTML, CSS, React.js, Redux, Javascript, Webpack, Express.js, Node.js, Rxjs, jQuery and various others.
        </Typography>
        <Typography  align="left" paragraph>
          Apart from building amazing products, I am also a staff writer for freeCodeCamp, LogRocket, Codeburst, Noteworthy and  a speaker as well.
          I love giving back to the community the technologies I learn through blogs or tech talks using interactive demos.
        </Typography>
      </main>
      <Footer />
    </React.Fragment>
